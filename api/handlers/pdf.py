...
@bp.route('/api/pdf/scan-qr', methods=['POST'])
def scan_qr():
    try:
...
@bp.route('/api/pdf/search-text', methods=['POST'])
def search_text_pdf():
    try:
        body = request.json
...
@bp.route('/api/pdf/activiness-letter', methods=['POST'])
...
# 4. GENERATE TICKET
@bp.route('/api/pdf/ticket', methods=['POST'])
def generate_ticket():
    try:
        body = request.json
...
@bp.route('/api/pdf/certificate-preview', methods=['POST'])
...
@bp.route('/api/pdf/certificate', methods=['POST'])
